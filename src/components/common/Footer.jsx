...
const Footer = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_cv19wq5', 'template_88enle2', form.current, {
    ...
    return (
        <section className='px-3 pt-15 sm:pt-17.5 md:pt-20 bg-black -mt-px'>
            <div className='max-w-7xl w-full mx-auto flex flex-col items-center'>
                <div className='flex min-[743px]:gap-6 max-[956px]:flex-wrap max-[956px]:pr-20 max-[850px]:pr-0 flex-row w-full justify-between'>
                                ...
                                <div key={index} className="gap-5 flex flex-col items-start">
                                    ...
                                    <ul className="text-cool-gray space-y-3 text-start ">
                                        {section.links.map((link, idx) => (
                                            <li
                                                key={idx}
                                                className="font-normal lg:text-base text-sm leading-156 hover:underline transition-all duration-500 "
                                            >
                    ...
                    <div className='max-w-89.5 w-full flex min-[758px]:mt-0 mt-10 flex-col text-start'>
                        <h2 className='font-medium text-xl leading-120 text-white mb-5'>Newsletter</h2>
                        ...
                        <form ref={form} onSubmit={sendEmail}>
                            <input
                                ...
                                required
                                className="border border-dark-charcoal bg-jet-black rounded-[9px] px-6 py-[14.5px] w-full font-normal text-base leading-156 outline-none text-light-gray placeholder:text-light-gray"
                            />

                            <p className="max-w-82 w-full font-normal lg:text-base text-sm leading-156 text-cool-gray mt-3 mb-6.25">Be The First One To Get Latest Updates And Stay Connected</p>
